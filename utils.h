 ...
 */
static inline float frand(float to)
{
 ...
 */
static inline double fitness_mean(double *arr, int size)
{
    assert(size);
 ...
 */
static inline double fitness_stdev(double *arr, int size)
{
    assert(size);
 ...
 */
static inline double fitness_min(double *arr, int size)
{
    assert(size >= 1);
 ...
 */
static inline double fitness_max(double *arr, int size)
{
    assert(size >= 1);
 ...
 */
static inline int contains(int *array, int size, int value)
{
    if(!size) return 0;
    for (int i=0; i<size; i++)
